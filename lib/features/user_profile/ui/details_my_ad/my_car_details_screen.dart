...
import '../../../product_details/data/model/car_details_model.dart';
import '../../../product_details/ui/logic/cubit/car_details_cubit.dart';
import '../../../product_details/ui/widgets/car_details/widgets/car_add_comment_field.dart';
import '../../../product_details/ui/widgets/car_details/widgets/car_bottom_actions.dart';
import '../../../product_details/ui/widgets/car_details/widgets/car_comments_view.dart';
import '../../../product_details/ui/widgets/car_details/widgets/car_details_app_bar.dart';
import '../../../product_details/ui/widgets/car_details/widgets/car_details_images.dart';
import '../../../product_details/ui/widgets/car_details/widgets/car_details_panel.dart';
import '../../../product_details/ui/widgets/car_details/widgets/car_info_description.dart';
import '../../../product_details/ui/widgets/car_details/widgets/car_info_grid_view.dart';
import '../../../product_details/ui/widgets/car_details/widgets/car_owner_info.dart';
import '../../../product_details/ui/widgets/car_details/widgets/car_price.dart';
import '../../../product_details/ui/widgets/car_details/widgets/car_similar_ads.dart';
import '../../../product_details/ui/widgets/car_details/widgets/car_story_and_title.dart';
...
class MyCarDetailsScreen extends StatelessWidget {
  final int id;

  const MyCarDetailsScreen({super.key, required this.id});
                          ...
                          builder: (context, adsState) {
                            ...
                            return CarStoryAndTitle(
                              ...
                              onOpenDetails: (product) {
                                ...
                                //   // افتراضي: إعلان عام
                                //
                                //  Navigator.push(context, MaterialPageRoute(builder: (context)=>ProductDetailsScreen(auctionsModel: null,)));
                                // }
                              },
                            );
                          },
                ...
                child: DottedBorder(
                  ...
                  child: Padding(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      onPressed: () {
                        // // 👈 تنقل إلى شاشة تعديل السيارة (اسم شاشة أخرى)
                        // NavX(context).pushNamed(Routes.carEditScreen, arguments: id);
                      },
