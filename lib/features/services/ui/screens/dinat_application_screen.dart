...
class _DinatApplicationScreenState extends State<DinatApplicationScreen> {
  ...
  final List<String> vehicleTypes = ['بيك أب', 'شاحنة', 'فان', 'مقطورة'];
  final List<String> vehicleConditions = ['ممتاز', 'جيد', 'متوسط'];
  ...
  String _mapVehicleType(String? a) {
    switch (a) {
      case 'بيك أب':
        return 'pickup';
      case 'شاحنة':
  ...
  String _mapVehicleStatus(String? a) {
    switch (a) {
      case 'ممتاز':
        return 'excellent';
      case 'جيد':
          ...
          listener: (context, state) {
            if (state is ServiceRequestLoading) {
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('جارٍ إرسال الطلب...')),
              );
                      ...
                      children: [
                        ...
                        DetailSelector(
                          ...
                          widget: DropdownButtonFormField<String>(
                            ...
                            decoration: _dec('حدد نوع المركبة'),
                        ...
                        DetailSelector(
                          ...
                          widget: DropdownButtonFormField<String>(
                            ...
                            items: vehicleConditions
                                .map((e) => DropdownMenuItem(value: e, child: Text(e, style: TextStyles.font16Black500Weight)))
                                .toList(),
                            onChanged: (v) => setState(() => selectedVehicleCondition = v),
                            decoration: _dec('حدد حالة المركبة'),
                            validator: (v) => v == null ? 'الحقل مطلوب' : null,
                          ),
                        ),
                        verticalSpace(16),
                        ...
                        SecondaryTextFormField(
                          ...
                          hint: 'أدخل تفاصيل إضافية للخدمة',
                          maxheight: 96.w,
                          minHeight: 96.w,
                        ...
                        MyButton(
                          ...
                          onPressed: () {
                            ...
                            if (selectedRegion == null || selectedCity == null || _pickedLatLng == null) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(content: Text('الرجاء اختيار المنطقة والمدينة والموقع')),
                              );
                              return;
                            }

                            final extras = <String, dynamic>{
                              'vehicle_type': _mapVehicleType(selectedVehicleType),
                              'vehicle_status': _mapVehicleStatus(selectedVehicleCondition),
                            };
                            ...
                            final req = CreateServiceRequest(
                              ...
                              scheduleTimeIso: null, // لو حتضيف وقت لاحق ارسل ISO
