...
class RealEstateRequestInfoDescription extends StatefulWidget {
  final String? description;
  const RealEstateRequestInfoDescription({
    super.key,
    required this.description,
  });

  @override
  State<RealEstateRequestInfoDescription> createState() =>
      _RealEstateInfoDescriptionState();
}

class _RealEstateInfoDescriptionState extends State<RealEstateRequestInfoDescription> {
