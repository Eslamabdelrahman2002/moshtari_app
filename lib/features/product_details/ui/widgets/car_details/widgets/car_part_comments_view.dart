...
class CarPartCommentsView extends StatelessWidget {
  final List<dynamic> comments; // يقبل Comment أو Map<dynamic,dynamic>

  const CarPartCommentsView({super.key, required this.comments});
  ...
  Widget build(BuildContext context) {
    ...
    String _name(dynamic c) {
      ...
      // fallback: اسم المستخدم الحالي أو "مستخدم"
    ...
    DateTime? _createdAt(dynamic c) {
      try {
        final v = (c as dynamic).createdAt; // لو الموديل بيدعمها
      ...
      return null; // ليس ضروريًا، CommentItem يتعامل مع null
    }
