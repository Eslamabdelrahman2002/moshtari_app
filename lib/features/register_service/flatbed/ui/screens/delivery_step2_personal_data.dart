...
class DeliveryStep2PersonalData extends StatefulWidget {
  final VoidCallback onNext;
  const DeliveryStep2PersonalData({super.key, required this.onNext});

  @override
  State<DeliveryStep2PersonalData> createState() => _DeliveryStep2PersonalDataState();
}

class _DeliveryStep2PersonalDataState extends State<DeliveryStep2PersonalData> {
  // حقول إدخال
