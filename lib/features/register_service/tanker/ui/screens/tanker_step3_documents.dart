...
class TankerStep3Documents extends StatefulWidget {
  final VoidCallback onNext;
  const TankerStep3Documents({super.key, required this.onNext});

  @override
  State<TankerStep3Documents> createState() => _TankerStep3DocumentsState();
}

class _TankerStep3DocumentsState extends State<TankerStep3Documents> {
