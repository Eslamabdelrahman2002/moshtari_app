...
class DynaMyTripsScreen extends StatefulWidget {
  const DynaMyTripsScreen({super.key});

  @override
  State<DynaMyTripsScreen> createState() => _DynaMyTripsScreenState();
}

class _DynaMyTripsScreenState extends State<DynaMyTripsScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<DynaMyTripsCubit>().initLoad(pageSize: 10);
    });
  ...
  Future<void> _pickCity({required bool from}) async {
    ...
    if (city != null) {
      ...
      if (from) cubit.setFromCity(city);
      else cubit.setToCity(city);
    }
  }
  ...
  Widget build(BuildContext context) {
    return BlocProvider<DynaMyTripsCubit>(
      create: (_) => getIt<DynaMyTripsCubit>(),
      child: Scaffold(
        appBar: AppBar(
          title: Text('رحلاتي', style: TextStyles.font20Black500Weight),
          centerTitle: true,
        ...
        body: BlocBuilder<DynaMyTripsCubit, DynaTripsListState>(
                  ...
                  child: RefreshIndicator(
                    ...
                    child: state.loading && state.items.isEmpty
                      ...
                      children: [
                        ...
                        SizedBox(height: 8.h),
                        TextButton(
                          onPressed: () => context.read<DynaMyTripsCubit>().initLoad(pageSize: state.pageSize),
