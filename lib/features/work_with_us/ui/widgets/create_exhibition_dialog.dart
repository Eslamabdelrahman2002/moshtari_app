...
import '../logic/cubit/exhibition_create_cubit.dart';
import '../logic/cubit/exhibition_create_state.dart';
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                Text('إنشاء حساب الآن', style: TextStyles.font20Black500Weight, textAlign: TextAlign.center),
                SizedBox(height: 6.h),
                Text('يرجى ملء التفاصيل وإنشاء الحساب', style: TextStyles.font12DarkGray400Weight, textAlign: TextAlign.center),
                verticalSpace(16),
                      ...
                      children: [
                        ...
                        DropdownButtonFormField<City>(
                          ...
                          items: state.cities
                              ...
                              .toList(),
                          onChanged: (_selectedRegion == null || state.citiesLoading) ? null : (c) => setState(() => _selectedCity = c),
                          decoration: InputDecoration(
