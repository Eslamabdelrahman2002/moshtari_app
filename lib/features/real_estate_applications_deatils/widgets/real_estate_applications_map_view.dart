...
class RealEstateApplicationsMapView extends StatefulWidget {
  final double latitude;
  final double longitude;
  const RealEstateApplicationsMapView(
      {super.key, this.latitude = 24.714648, this.longitude = 46.667786});
  ...
  @override
  State<RealEstateApplicationsMapView> createState() =>
      _RealEstateApplicationsMapViewState();
}

class _RealEstateApplicationsMapViewState
    extends State<RealEstateApplicationsMapView> {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: GoogleMap(
        ...
        initialCameraPosition: RealEstateApplicationsMapView._mecca,
